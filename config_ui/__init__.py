...
class Config_window:
    def __init__(self):
        ...
        hour_entry = tk.Entry(self.root)
        hour_entry.grid(column=1, row=0, sticky=tk.EW, padx=5, pady=5)

        # minutes
        minute_label = tk.Label(self.root, text="Minute:")
        minute_label.grid(column=0, row=1, sticky=tk.EW, padx=5, pady=5)

        minute_entry = tk.Entry(self.root,  show="*")
        minute_entry.grid(column=1, row=1, sticky=tk.EW, padx=5, pady=5)
        ...
        minute_entry = tk.Entry(self.root,  show="*")
        minute_entry.grid(column=1, row=2, sticky=tk.EW, padx=5, pady=5)
